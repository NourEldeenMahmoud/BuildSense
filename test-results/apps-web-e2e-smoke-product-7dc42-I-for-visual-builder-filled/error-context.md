...
- Name: apps\web\e2e\smoke.spec.ts >> production configuration resolves to Not Found UI for __visual/builder-filled
- Location: apps\web\e2e\smoke.spec.ts:8:1
...
Call log:
  - navigating to "/__visual/builder-filled", waiting until "load"
