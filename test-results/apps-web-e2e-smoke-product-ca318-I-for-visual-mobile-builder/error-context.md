...
- Name: apps\web\e2e\smoke.spec.ts >> production configuration resolves to Not Found UI for __visual/mobile-builder
- Location: apps\web\e2e\smoke.spec.ts:23:1
...
Call log:
  - navigating to "/__visual/mobile-builder", waiting until "load"
