...
- Name: apps\web\e2e\smoke.spec.ts >> production capability boundary >> production Purchase Plan has no fixture data, API calls, or totals
- Location: apps\web\e2e\smoke.spec.ts:63:3
...
Call log:
  - navigating to "/purchase-plan", waiting until "load"
