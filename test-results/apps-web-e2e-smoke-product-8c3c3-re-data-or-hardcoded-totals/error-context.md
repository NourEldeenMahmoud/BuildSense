...
- Name: apps\web\e2e\smoke.spec.ts >> production capability boundary >> production Builder has no fixture data or hardcoded totals
- Location: apps\web\e2e\smoke.spec.ts:29:3
...
Call log:
  - navigating to "/builder", waiting until "load"
