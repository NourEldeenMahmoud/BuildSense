...
- Name: apps\web\e2e\smoke.spec.ts >> production configuration resolves to Not Found UI for __visual/component-selection
- Location: apps\web\e2e\smoke.spec.ts:13:1
...
Call log:
  - navigating to "/__visual/component-selection", waiting until "load"
